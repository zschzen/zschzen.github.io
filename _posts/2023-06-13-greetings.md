---
title: Greetings, Fellow Adventurers!
author: leandro
date: 2023-06-13 10:00:00 +0800
pin: true
---
...
In order to **improve the quality and relevance** of the content on this blog, I use a web analytics service called [Google Analytics]. This service allows me to gain valuable insights into how you, as readers, interact with the blog, such as which posts are the most popular, how long you spend on each page, and your geographic locations.

Please note that Google Analytics uses cookies to collect **anonymous information** and generate reports on website usage. These cookies do not personally identify you or provide access to any personal information. The data collected by Google Analytics is used solely for the purpose of **analyzing website traffic** and optimizing the content to better serve you.

I greatly value your **privacy** and am committed to ensuring the **security** of your information. Any data collected by Google Analytics is subject to [Google's Privacy Policy], which you can review for more information.

### Blocking Google Analytics

If you wish to **block Google Analytics** from collecting data about your website usage, you can install the [Google Analytics Opt-out Browser Add-on]. This add-on is available for most popular browsers, including Chrome, Firefox, Internet Explorer, Safari, and Opera.
...
I hope you've enjoyed getting to know the purpose of this blog, understanding the licenses associated with the code shared, and learning about my use of Google Analytics to improve your reading experience.
...
[Submission Guidelines]: https://assetstore.unity.com/publishing/submission-guidelines#1.%20Content%20Restrictions
