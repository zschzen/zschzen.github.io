---
title: Basics of Trigonometry - Sine & Cosine
author: leandro
date: 2023-06-19 15:00:00 +0800
categories: [Gamedev, Math, Programming]
tags: [cosine, gamedev, math, sine, trigonometry, Unity]
math: true
image:
  path: /assets/img/posts/basic-trigonometric/circle-point.gif
---
...
## A Geometric Interpretation of Sine and Cosine

### Pythagorean Theorem

![Pythagorean Theorem](/assets/img/posts/basic-trigonometric/pythagorean-theorem.png){: .left .w-50 .shadow .rounded-10 }
...
![SohCah](/assets/img/posts/basic-trigonometric/soh-cah.png){: .right .w-50 .shadow .rounded-10 }
...
![Unit Circle](/assets/img/posts/basic-trigonometric/unit-circle.png)

![Unit Circle](/assets/img/posts/basic-trigonometric/circle-point.gif){: .left .w-50 .shadow .rounded-10 }
...
{% include iframe.html type='local' url='assets/vectorjs' content='basic-unit-circle' title='Basic Unit Circle' legend='A unit circle with a radius of 1. Addapted from <a href="https://vectorjs.org/examples/unit-circle/">Vector.js (Kurt Bruns)</a>.' %}
...
![Placement](/assets/img/posts/basic-trigonometric/placement-movement.gif){: .shadow }
...
![Pendulum](/assets/img/posts/basic-trigonometric/pendulum-motion.gif){: .right .w-40 .shadow }
...
![Spiral motion](/assets/img/posts/basic-trigonometric/spiral-movement.gif){: .shadow .w-30 }

## Conclusion

That's it! We learned the basics of trigonometry and how to use it to place and move objects in space. We also learned how to convert between degrees, radians, and turns. I hope you enjoyed this post and learned something new today!
