...
point.constrain = (o, n) => {
    ...
    // update labels
    maginitudeLabel.x = (line.x2 / 2) - 15;
    maginitudeInverseLabel.x = -maginitudeLabel.x;

    maginitudeLabel.y = (line.y2 / 2) - 15;
    maginitudeInverseLabel.y = -maginitudeLabel.y;
...
let maginitudeLabel = interactive.text(point.y / 2, xAxis.y2, 'a');
maginitudeLabel.setAttribute('alignment-baseline', 'middle');
let maginitudeInverseLabel = interactive.text(point.y / 2, xAxis.y2, '-a');
maginitudeInverseLabel.setAttribute('alignment-baseline', 'middle');
