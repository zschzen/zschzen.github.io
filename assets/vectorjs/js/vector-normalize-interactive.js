...
lineDIR.update = () => {
    ...
    uLabel.x = (lineDIR.x2 / 2) - 10;
    uLabel.y = (lineDIR.y2 / 2) - 10;
};
...
point.constrain = (o, n) => {
    ...
    maginitudeLabel.y = (line.y2 / 2) - 10;
...
let uLabel = interactive.text(lineDIR.y2 / 2, xAxis.y2, 'u');
uLabel.setAttribute('alignment-baseline', 'middle');
